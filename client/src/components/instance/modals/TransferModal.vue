      ...
      >
        ...
        <div class="modal-content max-w-lg">
          ...
          <div class="modal-header">
            <h3 class="modal-title">{{ $t('transfer.modal.title') }}</h3>
            <button
          ...
          <div class="modal-body space-y-4">
            <!-- Instance Info -->
            <div class="p-3 rounded-lg border border-themed bg-themed-secondary">
            ...
            <!-- Target User Search -->
            <div>
              <label class="block text-sm font-medium mb-1 text-themed-secondary">{{ $t('transfer.modal.targetUser') }}</label>
              ...
              <p v-if="searchError" class="text-sm text-error mt-1">{{ searchError }}</p>
            </div>

            <!-- Target User Info -->
            <div
              v-if="targetUser"
              class="p-4 rounded-lg border border-themed bg-themed-secondary"
            >
              ...
              <div
                v-if="canTransfer"
                class="mt-2 p-2 rounded text-sm bg-success/10 text-success"
              >
            ...
            <!-- Remark -->
            <div>
              <label class="block text-sm font-medium mb-1 text-themed-secondary">{{ $t('transfer.modal.remark') }}</label>
              <textarea
                v-model="remark"
            ...
            <div
              v-if="transferFee > 0"
              class="p-3 rounded-lg border border-themed bg-themed-secondary text-sm space-y-2"
            >
              ...
              <div class="flex items-center justify-between">
                ...
                <span
                  class="font-medium"
                  :class="hasEnoughBalance ? 'text-success' : 'text-error'"
                >
              ...
              <div
                ...
                class="pt-2 border-t border-themed"
              >
                <p class="text-error">{{ $t('transfer.modal.insufficientBalance') }}</p>
              </div>
              <!-- Fee Refund Hint -->
