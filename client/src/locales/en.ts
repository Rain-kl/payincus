export default {
    ...
    nav: {
        ...
        instanceManage: 'Instances',
        instanceTerminal: 'Terminal',
        transferInstance: 'Transfers',
        domainMail: 'Domain Mail',
        myWallet: 'My Wallet',
        myOrders: 'My Orders',
        giftCardsTicket: 'Gift Cards',
    ...
    promosAdmin: {
        ...
        subtitle: 'Create and manage marketing discount coupons with scope matching, duration slicing, and anti-arbitrage guards.',
        ...
        filters: {
            ...
            typeAll: 'All Types',
            typeAdmin: 'Official Promo',
            typeAff: 'Affiliate Code',
        ...
        discountType: {
            ...
            percentageDesc: '{rate}% Off',
            fixedAmountDesc: '¥{amount} Off',
        },
        durationType: {
            once: 'First Order Once',
            repeating: '{cycles} Cycles',
            forever: 'Forever',
        },
        scopeType: {
            global: 'Global',
        ...
        drawer: {
            ...
            codePlaceholder: 'e.g. SUMMER2026 (3-32 uppercase letters/digits)',
            generateRandom: 'Generate Random',
            nameLabel: 'Name / Remark',
            namePlaceholder: 'e.g. Summer 2026 Big Sale',
            discountTypeLabel: 'Discount Type',
            discountValueLabel: 'Discount Value',
            discountPercentageLabel: 'Discount Percentage (%)',
            discountPercentagePlaceholder: 'Enter a number between 0 and 100 (e.g. 20 for 20% off)',
            discountPercentageHint: 'Enter 0-100 percentage (e.g. 20 means 20% discount)',
            discountFixedLabel: 'Discount Amount (CNY)',
            discountFixedPlaceholder: 'Enter fixed discount amount (e.g. 15.00)',
            discountPreviewPercentage: 'Example: ¥100 order discounts ¥{discount}, final ¥{final}',
            discountPreviewFixed: 'Example: ¥100 order discounts ¥{discount}, final ¥{final}',
            discountValuePercentagePlaceholder: 'Enter discount rate (e.g. 20 for 20% off)',
            discountValueFixedPlaceholder: 'Enter fixed discount amount (CNY)',
            fixedAmountNotice: 'Notice: Fixed amount discount will be strictly locked to [First Order Once (ONCE)].',
            durationModeLabel: 'Duration Mode',
            durationOnce: 'First Order Once (1 Cycle)',
            durationRepeating: 'Multiple Cycles (Custom)',
            durationForever: 'Lifetime (Forever)',
            durationTypeLabel: 'Duration Type',
            durationCyclesLabel: 'Valid Cycles (Months)',
            durationCyclesPlaceholder: 'Enter number of cycles (e.g. 3, 6, 12)',
            durationCyclesHint: 'Enter number of cycles (e.g. 6 for 6 months discount), reverts to normal price after.',
            scopeTypeLabel: 'Scope',
            scopeGlobal: 'Global (All packages and plans)',
            scopeCustom: 'Specific Packages / Plans',
            scopeSelectionHint: 'Selecting a package applies to all its plans, or expand package to select specific plans.',
            expandAll: 'Expand All',
            collapseAll: 'Collapse All',
            expandPlans: 'Show Plans ({count})',
            collapsePlans: 'Hide Plans',
            packageScopeWhole: 'Apply to all plans in package',
            planCoveredByPackage: 'Covered by whole package',
            noPlansForPackage: 'No plans in this package',
            loadingPlans: 'Loading plans...',
            scopeSelectedSummary: '{packages} whole packages, {plans} plans selected',
            loadingPackages: 'Loading packages and plans...',
            noPackages: 'No packages available',
            maxTotalUsesLabel: 'Total Max Uses',
            maxTotalUsesPlaceholder: 'Leave empty for unlimited',
            maxUsesPerUserLabel: 'Max Uses Per User',
            maxUsesPerUserPlaceholder: 'Default: 1',
            startsAtLabel: 'Start Time',
            expiresAtLabel: 'Expiration Time',
            enabledLabel: 'Enable immediately',
            immutableNotice: 'Immutable',
            editImmutableNotice: 'Notice: Promo code, discount type, discount value, duration mode, and scope cannot be modified after creation. You can only update name, limits, active dates, and status.',
            cancelButton: 'Cancel',
        ...
        instancesDrawer: {
            title: 'Bound Instances - {code}',
            instanceName: 'Instance Name',
            username: 'Owner',
            cyclesProgress: 'Cycle Progress',
            boundAt: 'Bound At',
            actions: 'Actions',
            unbindButton: 'Unbind',
            unbinding: 'Unbinding...',
            unbindConfirmTitle: 'Confirm Unbind Instance?',
            unbindConfirmMessage: 'After unbinding, next renewal will be at standard full price and an inbox message will be sent.',
            emptyText: 'No instances bound to this promo code',
        },
        toast: {
            loadSuccess: 'Promo codes refreshed',
            loadFailed: 'Failed to load promo codes: {message}',
            createSuccess: 'Promo code created successfully',
            createFailed: 'Failed to create promo code: {message}',
            editSuccess: 'Promo code updated successfully',
            editFailed: 'Failed to update promo code: {message}',
            toggleSuccess: 'Promo code status updated',
            toggleFailed: 'Failed to update status: {message}',
            deleteSuccess: 'Promo code deleted successfully',
            deleteFailed: 'Failed to delete promo code: {message}',
            unbindSuccess: 'Instance unbound successfully',
            unbindFailed: 'Failed to unbind instance: {message}',
            deleteConfirmTitle: 'Confirm Delete Promo Code?',
            deleteConfirmMessage: 'Deleting will unbind all currently bound instances and restore official prices. All affected users will be notified. This action cannot be undone!',
            invalidCode: 'Please enter a valid 3-32 uppercase promo code',
            invalidDiscount: 'Please enter a valid discount value',
            invalidPercentage: 'Percentage discount must be between 0 and 100',
            invalidFixedAmount: 'Discount amount must be greater than 0',
            invalidCycles: 'Valid cycles must be an integer >= 1',
            scopeRequired: 'Non-global promo codes must have at least one package or plan selected',
        },
    },
    ...
    instance: {
        ...
        autoRemotePortDesc: 'Automatically map a public port to the remote port (Linux 22 / Windows 3389). This mapping does not count against your port quota.',
            ...
            cannotBuyOwn: 'Cannot purchase your own paid package',
            selectPlanRequired: 'Please select a plan',
            planSoldOut: 'Selected plan is sold out',
            selectHostRequired: 'Please select a host',
            selectImageRequired: 'Please select an OS image',
            selectSshKey: 'Please select an SSH key',
            authMethod: 'Authentication',
            authMethodSsh: 'SSH Key',
            authMethodPassword: 'Password',
            passwordModeAuto: 'Auto Generated',
            passwordModeAutoDesc: 'System generates a 16-character strong password',
            passwordModeCustom: 'Custom Password',
            passwordModeCustomDesc: 'Set root password manually',
            autoPasswordHint: 'The system will automatically generate a 16-character strong password upon creation, which can be viewed and copied in the instance details.',
            passwordLabel: 'Root Password',
            passwordPlaceholder: 'Enter root password (8-64 chars, uppercase, lowercase, numbers)',
            generatePassword: 'Generate',
            passwordTooWeak: 'Password too weak: requires 8-64 characters with uppercase, lowercase, and numbers',
            passwordRequired: 'Please enter root password',
            switchToPassword: 'Switch to Password',
            noSshKeyConfigured: 'No SSH Key Found',
            noSshKeyHint: 'No SSH key configured for this account. You can use password authentication instead, or add a key in profile settings.',
            creating: 'Creating...',
        ...
        subscription: {
            ...
            applyAffTitle: 'Bind Promo Code',
            applyAffInstance: 'Instance',
            applyAffCurrentRenewPrice: 'Current renew price',
            applyAffCodeLabel: 'Promo code',
            applyAffCodePlaceholder: 'Enter promo code',
    ...
    admin: {
        dashboard: {
            ...
            description: 'Aggregated status for instances, users, billing and infrastructure',
            autoRefresh: 'Auto Refresh (30s)',
            quickActions: 'Quick Actions',
            actionHubTitle: 'Operations & Risk Radar',
            allClearTitle: 'All Systems Operational',
            allClearDescription: 'All infrastructure nodes, payment providers and delivery queues are healthy with no blocking risks.',
            actionRequired: 'Action Required',
            actionCount: '{count} action items',
            viewDetails: 'Inspect',
            deliveryRisk: '{count} delivery task anomalies',
            orderRisk: '{count} orders need attention',
            hostRisk: '{count} hosts offline or stale',
            ticketRisk: '{count} tickets awaiting reply',
            otaRisk: '{count} update tasks failed',
            revenueTrend: 'Revenue & Consumption Trend',
            fulfillmentTitle: 'Today Order Fulfillment',
            fulfillmentSuccess: 'Completed',
            fulfillmentPending: 'Pending',
            fulfillmentFailed: 'Failed / Cancelled',
            fulfillmentRate: 'Fulfillment Rate {rate}%',
            instanceStructureTitle: 'Instance Distribution',
            expiringNotice: 'Expiring in 7 Days',
            expiringCount: '{count} units',
            runningHealthyRate: 'Healthy Rate',
            userConversionRate: 'Paid Conversion',
            platformPulseTitle: 'Platform Pulse',
            activeGateways: 'Active Gateways',
            smtpStatus: 'SMTP Service',
            smtpEnabled: 'Enabled',
            smtpDisabled: 'Disabled',
            hostsOverview: 'Host Nodes',
            agentFreshnessNote: 'Agent status based on 30-minute heartbeat window',
            marketingTitle: 'Active Campaigns',
            marketingDescription: 'Lottery draws, check-in benefits and participation',
            activeCampaignsBadge: '{count} Active',
            dailyCheckin: 'Daily Check-in',
            checkinEnabled: 'Enabled',
            checkinDisabled: 'Disabled',
            checkinRule: 'Random {min}~{max} pts',
            todayCheckinsCount: '{count} check-ins today',
            costPointsPerDraw: '{points} pts/draw',
            drawsCount: '{count} draws',
            longTermActive: 'Ongoing',
            noActiveLotteries: 'No active lotteries at the moment',
            manageMarketing: 'Manage Campaigns ➔',
            recentInstancesTitle: 'Recent Provisioning',
            recentInstancesDescription: 'Latest created and delivered instances across the platform',
            newInstancesTodayBadge: '+{count} new today',
            noRecentInstances: 'No recent provisioning records',
            viewAllInstances: 'All Instances ➔',
            pendingTicketsTitle: 'Pending Tickets',
            pendingTicketsDescription: 'User tickets requiring administrative attention and response',
            pendingTicketsBadge: '{count} pending',
            noPendingTickets: 'No pending tickets, all requests resolved',
            manageTickets: 'Ticket Center ➔',
        ...
        hosts: {
            ...
            directMode: 'Direct (Public IP)',
            tunnelMode: 'Reverse Tunnel (Agent WebSocket)',
            tunnelNotice: 'Agent reverse tunnel mode enabled. No public IP or inbound firewall ports required on the host.',
            targetPort: 'Communication Port',
            targetPortHint: 'Incus internal API port, default 8443',
            targetHost: 'Local Target Address',
            targetHostHint: 'Local loopback target on the host, default 127.0.0.1',
            ...
            tabCreate: 'Create',
            basicInfo: 'Basic Info',
            basicInfoHint: 'Host name, region and IPv6 subnet details.',
            connectionConfig: 'Network Connection',
            connectionConfigHint: 'How the backend and this host connect to each other.',
            resourceTitle: 'Resources & Quota',
            resourceTitleHint: 'Per-instance CPU, memory limits and instance types.',
            natConfigHint: 'Public addresses shown to users and the addresses the NAT actually listens on.',
            deliveryTitle: 'Delivery & Display',
            deliveryTitleHint: 'Notifications, resource pool, announcement and probe URL shown to users.',
            config: 'Config',
        ...
        images: {
            ...
            batchDelete: 'Delete Selected',
            confirmBatchDisable: 'Are you sure to disable {count} selected images?',
            confirmBatchEnable: 'Are you sure to enable {count} selected images?',
            confirmBatchDelete: 'Are you sure to delete {count} selected images? This action cannot be undone.',
            batchDisableSuccess: '{count} images disabled',
            batchEnableSuccess: '{count} images enabled',
    ...
    traffic: {
        ...
        thisPeriod: 'Traffic · This Period',
        historySubtitle: 'Inbound + Outbound total, daily statistics',
        days30: '30 Days',
        days60: '60 Days',
        days90: '90 Days',
        ...
        nextFreeReset: 'Next free reset',
        paidResetHint: 'Next free reset on {date} · Reset for CN¥{price} when exhausted',
    ...
    host: {
        ...
        caddy: {
            ...
            enabled: 'Enabled',
            disabled: 'Disabled',
            notInstalled: 'Caddy is not installed yet. Click the button below to have the Agent install it on the host.',
