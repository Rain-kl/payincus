...
const zhTW = {
    ...
    nav: {
        ...
        userCenter: '使用者中心',
        instanceManage: '實例管理',
        instanceTerminal: '實例終端',
        transferInstance: '轉移實例',
        domainMail: '網域信箱',
        myWallet: '我的錢包',
        myOrders: '我的訂單',
        giftCardsTicket: '禮品卡券',
        inviteFriends: '邀請好友',
        myFriends: '我的好友',
        ticketSupport: '工單支援',
        helpCenter: '說明中心',
    ...
    promosAdmin: {
        title: '優惠碼管理',
        subtitle: '建立與管理行銷折扣券，支援全場通用與樹狀套餐/方案範圍匹配、長週期切片核銷與反套利風控。',
        createButton: '建立優惠碼',
        refreshButton: '重新整理',
        stats: {
            totalCodes: '優惠碼總數',
            activeCodes: '生效中券碼',
            activeBindings: '活躍綁定實例',
            totalDiscounted: '累計減免金額',
        },
        filters: {
            searchPlaceholder: '搜尋優惠碼或備註...',
            typeAll: '所有類型',
            typeAdmin: '官方行銷券',
            typeAff: '使用者推廣碼',
            statusAll: '所有狀態',
        ...
        discountType: {
            ...
            fixedAmountDesc: '立減 ¥{amount}',
        },
        durationType: {
            once: '首期一次性',
            repeating: '循環 {cycles} 期',
            forever: '終身有效',
        },
        scopeType: {
            global: '全場通用',
            custom: '指定 {count} 個套餐/方案',
            packageCount: '{count} 個套餐',
        },
        drawer: {
            createTitle: '建立優惠碼',
            editTitle: '編輯優惠碼',
            codeLabel: '優惠券碼',
            codePlaceholder: '如 SUMMER2026（3-32位大寫字母/數字）',
            generateRandom: '隨機產生',
            nameLabel: '名稱 / 備註',
            namePlaceholder: '如 2026年夏季大促活動券',
            discountTypeLabel: '折扣類型',
            discountValueLabel: '折扣數值',
            discountPercentageLabel: '折扣百分比 (%)',
            discountPercentagePlaceholder: '請輸入 0-100 的數值（如 20 代表 20% 減免）',
            discountPercentageHint: '請輸入 0 到 100 的百分數（如 20 代表減免 20% / 8折）',
            discountFixedLabel: '立減金額 (元)',
            discountFixedPlaceholder: '請輸入立減金額（如 15.00）',
            discountPreviewPercentage: '例如：¥100 訂單將減免 ¥{discount}，實付 ¥{final}',
            discountPreviewFixed: '例如：¥100 訂單將立減 ¥{discount}，實付 ¥{final}',
            discountValuePercentagePlaceholder: '輸入折扣比例（如 20 代表減免 20%）',
            discountValueFixedPlaceholder: '輸入減免金額（元）',
            fixedAmountNotice: '提示：金額立減優惠碼將自動鎖定為【首期一次性 (ONCE)】，不參與後續續約循環。',
            durationModeLabel: '有效週期模式',
            durationOnce: '僅首期一次性 (1 期)',
            durationRepeating: '連續多期 (自訂期數)',
            durationForever: '終身永久有效',
            durationTypeLabel: '有效週期',
            durationCyclesLabel: '有效週期數 (期/月)',
            durationCyclesPlaceholder: '請輸入有效週期數（如 3、6、12）',
            durationCyclesHint: '輸入數字期数（例如填 6 表示連續 6 個月享受折扣），期滿後自動恢復原價續約。',
            scopeTypeLabel: '適用範圍',
            scopeGlobal: '全場通用（適用於所有套餐方案）',
            scopeCustom: '指定套餐或方案（樹狀多選）',
            scopeSelectionHint: '勾選套餐時，名下所有子方案均自動生效；也可以展開套餐僅勾選特定子方案。',
            expandAll: '全部展開',
            collapseAll: '全部收起',
            expandPlans: '展開方案 ({count})',
            collapsePlans: '收起方案',
            packageScopeWhole: '整套餐所有方案適用',
            planCoveredByPackage: '已由整套餐覆蓋',
            noPlansForPackage: '該套餐暫無可用方案',
            loadingPlans: '正在載入方案...',
            scopeSelectedSummary: '已選 {packages} 個整套餐，{plans} 個指定方案',
            loadingPackages: '正在載入可用套餐與方案清單...',
            noPackages: '未查詢到可用套餐',
            maxTotalUsesLabel: '全域總發行量',
            maxTotalUsesPlaceholder: '留空表示不限量',
            maxUsesPerUserLabel: '單一使用者限用次數',
            maxUsesPerUserPlaceholder: '預設為 1 次',
            startsAtLabel: '生效開始時間',
            expiresAtLabel: '失效截止時間',
            enabledLabel: '立即啟用該優惠碼',
            immutableNotice: '不可修改',
            editImmutableNotice: '說明：優惠券碼、折扣類型、折扣數值、有效週期模式及適用範圍一經建立不可修改，僅支援調整名稱備註、發行總量、單一使用者限額、有效時間及啟用狀態。',
            cancelButton: '取消',
            submitButton: '確認建立',
            submitting: '建立中...',
            saveButton: '儲存變更',
        ...
        instancesDrawer: {
            ...
            unbindButton: '解綁',
            unbinding: '解綁中...',
            unbindConfirmTitle: '確認解綁實例？',
            unbindConfirmMessage: '解綁後該實例下次續約將恢復標準原價，並會向使用者發送【優惠變更】站內信。',
            emptyText: '目前無實例綁定此優惠碼',
        },
        toast: {
            loadSuccess: '優惠碼清單已重新整理',
            loadFailed: '取得優惠碼清單失敗：{message}',
            createSuccess: '優惠碼建立成功',
            createFailed: '建立優惠碼失敗：{message}',
            editSuccess: '優惠碼修改成功',
            editFailed: '修改優惠碼失敗：{message}',
            toggleSuccess: '優惠碼狀態已更新',
            toggleFailed: '更新狀態失敗：{message}',
            deleteSuccess: '優惠碼已成功下線並刪除',
            deleteFailed: '刪除優惠碼失敗：{message}',
            unbindSuccess: '實例已成功解除綁定並發送通知',
            unbindFailed: '解除綁定失敗：{message}',
            deleteConfirmTitle: '確認下線並刪除此優惠碼？',
            deleteConfirmMessage: '刪除後，名下所有已綁定的實例將解除綁定並恢復官方原價，系統將批次向所有受影響使用者發送站內信通知。此操作不可逆！',
            invalidCode: '請輸入 3-32 位合法大寫優惠券碼',
            invalidDiscount: '請輸入合法的折扣數值',
            invalidPercentage: '百分比折扣必須在 0 到 100 之間',
            invalidFixedAmount: '立減金額必須大於 0',
            invalidCycles: '有效週期數必須為大於等於 1 的整數',
            scopeRequired: '非全場通用優惠碼必須至少選擇一個套餐或方案',
        },
    },
    ...
    userMenu: {
        summary: '概要資訊',
        profile: '使用者設定',
        consoleSettings: '主控台設定',
        myInstances: '我的實例',
        logout: '登出',
        identityDomain: '身分識別網域',
        tenant: '租用戶',
        language: '語言',
    },
    ...
    instance: {
        ...
        appliedFilters: '套用的篩選器',
        itemsPerPage: '每頁的項目數',
        actionsDropdown: '操作',
        allInstancesTip: '每個實例均配備獨立的計算、記憶體與儲存資源。請在實例詳情中配置網路位址與連接埠對應。',
        alwaysFree: '始終免費',
        compartment: '區間',
        rootCompartment: '根',
        pageInfo: '第 {page} 頁/共 {totalPages} 頁 (第 {start} - {end} 項/共 {total} 項)',
        manageDesc: '管理您的容器實例',
        ...
        autoRemotePortDesc: '自動對應一個公網連接埠到遠端連接埠（Linux 為 22，Windows 為 3389）。該對應不佔用你的連接埠配額。',
            ...
            turnstileFailed: '人機驗證失敗，請重試',
            selectPackage: '請選擇方案',
            packageSoldOut: '當前方案已售罄',
            cannotBuyOwn: '不能購買自己發布的付費方案',
            selectPlanRequired: '請選擇購買方案',
            planSoldOut: '所選方案已售罄',
            selectHostRequired: '請選擇宿主機',
            selectImageRequired: '請選擇系統映像檔',
            selectSshKey: '請選擇 SSH 金鑰',
            authMethod: '認證方式',
            authMethodSsh: 'SSH 金鑰',
            authMethodPassword: '密碼認證',
            passwordModeAuto: '系統隨機生成',
            passwordModeAutoDesc: '開通時自動生成 16 位強密碼',
            passwordModeCustom: '自訂密碼',
            passwordModeCustomDesc: '手動設定實例 root 密碼',
            autoPasswordHint: '系統將在建立時自動生成 16 位高強度密碼，建立完成後可在實例詳情或連線資訊中隨時查看與複製。',
            passwordLabel: 'Root 密碼',
            passwordPlaceholder: '請輸入 root 密碼（8-64位，含大小寫字母與數字）',
            generatePassword: '隨機生成',
            passwordTooWeak: '密碼強度不足：需 8-64 位，且包含大寫字母、小寫字母和數字',
            passwordRequired: '請輸入 root 密碼',
            switchToPassword: '切換為密碼連線',
            noSshKeyConfigured: '未偵測到 SSH 金鑰',
            noSshKeyHint: '目前帳號未新增 SSH 金鑰，可直接使用密碼連線，或前往個人設定新增公鑰。',
            creating: '建立中...',
        ...
        subscription: {
            ...
            applyAffCodeLabel: '優惠碼',
            applyAffCodePlaceholder: '輸入優惠碼',
    ...
    host: {
        ...
        caddy: {
            ...
            enabled: '已啟用',
            disabled: '未啟用',
            notInstalled: 'Caddy 尚未安裝，點擊下方按鈕由 Agent 在宿主机上自動安裝。',
            install: '安裝 Caddy',
    ...
    admin: {
        dashboard: {
            title: '營運大盤',
            description: '執行個體、使用者、計費與基礎設施運作狀態聚合',
            autoRefresh: '自動重新整理（30秒）',
            quickActions: '快捷操作',
            actionHubTitle: '維運待辦與風險雷達',
            allClearTitle: '系統運作平穩',
            allClearDescription: '所有基礎設施節點、支付管道及交付佇列運作正常，未發現阻斷風險。',
            actionRequired: '需介入處理',
            actionCount: '{count} 項待辦',
            viewDetails: '立即查看',
            deliveryRisk: '{count} 個交付任務異常',
            orderRisk: '{count} 筆訂單待核驗',
            hostRisk: '{count} 個節點離線或失聯',
            ticketRisk: '{count} 張工單待回覆',
            otaRisk: '{count} 個更新任務失敗',
            revenueTrend: '營收與消費趨勢',
            fulfillmentTitle: '今日訂單履約',
            fulfillmentSuccess: '已成功',
            fulfillmentPending: '待處理',
            fulfillmentFailed: '失敗/已取消',
            fulfillmentRate: '履約成功率 {rate}%',
            instanceStructureTitle: '執行個體構成與分佈',
            expiringNotice: '7 日內即將到期',
            expiringCount: '{count} 台',
            runningHealthyRate: '正常運作率',
            userConversionRate: '付費轉化率',
            platformPulseTitle: '平台運作事實',
            activeGateways: '活躍支付管道',
            smtpStatus: 'SMTP 郵件服務',
            smtpEnabled: '已啟用',
            smtpDisabled: '未啟用',
            hostsOverview: '宿主機節點',
            agentFreshnessNote: 'Agent 狀態按最近 30 分鐘活動訊號計算',
            marketingTitle: '進行中的活動',
            marketingDescription: '抽獎活動、簽到福利及參與熱度',
            activeCampaignsBadge: '{count} 個進行中',
            dailyCheckin: '每日簽到',
            checkinEnabled: '已開啟',
            checkinDisabled: '未開啟',
            checkinRule: '隨機 {min}~{max} 積分',
            todayCheckinsCount: '今日已簽到 {count} 人',
            costPointsPerDraw: '{points} 積分/次',
            drawsCount: '已抽 {count} 次',
            longTermActive: '長期有效',
            noActiveLotteries: '當前暫無進行中的抽獎活動',
            manageMarketing: '管理活動 ➔',
            recentInstancesTitle: '最近開機記錄',
            recentInstancesDescription: '系統最新建立與交付的執行個體情況',
            newInstancesTodayBadge: '今日新開 +{count} 台',
            noRecentInstances: '暫無最近開機記錄',
            viewAllInstances: '全部執行個體 ➔',
            pendingTicketsTitle: '待處理工單',
            pendingTicketsDescription: '需管理員跟進與回覆的用戶工單',
            pendingTicketsBadge: '{count} 條待處理',
            noPendingTickets: '暫無待處理工單，所有工單已完結',
            manageTickets: '進入工單中心 ➔',
            ticketPriorityUrgent: '緊急',
        ...
        images: {
            title: '映像檔管理',
            description: '管理系統映像檔庫，使用者可在建立實例時選擇這些映像檔',
            create: '新增映像檔',
            edit: '編輯映像檔',
            imagesTab: '映像檔庫',
            syncTab: '同步狀態',
            ...
            syncToHost: '同步映像檔到節點',
            delete: '刪除',
            confirmDelete: '確定刪除映像檔 "{name}"？',
            imageDeleted: '映像檔已刪除',
            deleteFailed: '刪除失敗',
            deleteSuccess: '映像檔已刪除',
            enabled: '啟用',
            disabled: '禁用',
            active: '已啟用',
            show: '顯示',
            ...
            statusVisible: '可見',
            statusHidden: '已隱藏',
            createSuccess: '映像檔建立成功',
            updateSuccess: '映像檔更新成功',
            saveFailed: '儲存失敗',
            loadFailed: '載入映像檔列表失敗',
            batchDisable: '批次禁用',
            batchEnable: '批次啟用',
            batchDelete: '批次刪除',
            confirmBatchDisable: '確定禁用選中的 {count} 個映像檔？',
            confirmBatchEnable: '確定啟用選中的 {count} 個映像檔？',
            confirmBatchDelete: '確定刪除選中的 {count} 個映像檔？此操作不可復原。',
            batchDisableSuccess: '已禁用 {count} 個映像檔',
            batchEnableSuccess: '已啟用 {count} 個映像檔',
            batchDeleteSuccess: '已刪除 {count} 個映像檔',
            selectedCount: '已選擇 {count} 項',
            clearSelection: '取消選擇',
            selectAll: '全選',
            validation: {
                requiredFields: '請填寫名稱、遠端別名和圖示',
            },
            fields: {
                icon: '圖示',
                name: '名稱',
            ...
            hint: {
                remoteAlias: 'Incus 遠端映像檔別名，如 ubuntu/noble/cloud',
                sortOrder: '越小排序越靠前',
                instanceType: '指定該映像檔適用於容器、虛擬機或兩者皆可',
            },
            typeContainer: '容器',
            typeVm: '虛擬機',
            typeBoth: '通用',
        ...
        hosts: {
            ...
            apiPortHint: '預設 8443',
            connectionMode: '連線方式',
            directMode: '主動直連 (公網 IP)',
            tunnelMode: '內網穿透 (Agent 反向通道)',
            tunnelNotice: '已啟用 Agent 反向穿透模式。宿主機無需公網 IP，無需防火牆放行入站連接埠。',
            targetPort: '通訊埠',
            targetPortHint: 'Incus 內部監聽通訊埠，預設 8443',
            targetHost: '本機轉發位址',
            targetHostHint: '宿主機本機迴環轉發目標，預設 127.0.0.1',
            tunnelConnected: '穿透已連線',
            tunnelDisconnected: '穿透未連線',
            ...
            tabCreate: '創建',
            basicInfo: '基本資訊',
            basicInfoHint: '節點名稱、地區與 IPv6 子網路資訊。',
            connectionConfig: '網路連線',
            connectionConfigHint: '設定後端與宿主機之間的連線方式。',
            resourceTitle: '資源與配額',
            resourceTitleHint: '單個實例可用的 CPU、記憶體上限與實例類型。',
            natConfigHint: '用戶存取連接埠映射時看到的公開地址與監聽地址。',
            deliveryTitle: '交付與展示',
            deliveryTitleHint: '通知、資源池、公告與探針等面向用戶的展示設定。',
            config: '設定',
            resourceLimits: '資源限制',
    ...
    traffic: {
        ...
        peak: '峰值',
        dailyAverage: '日均',
        nextFreeReset: '下次免費重設',
        paidResetHint: '下次免費重設 {date} · 用盡後可按 CN¥{price} 付費重設',
