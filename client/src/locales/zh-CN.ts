export default {
    hostPublicIpv4: {
        title: '独立 IPv4 地址池',
        description: '为独立 IPv4 套餐提供 routed 公网 IPv4 分配、回收和容量校验。',
        newPool: '新增地址池',
        newPoolTitle: '新增独立 IPv4 地址池',
        total: '总地址',
        empty: '暂无独立 IPv4 地址池。',
        enabled: '启用',
        disabled: '停用',
        ...
        address: '地址',
        instance: '实例',
        cidrOptional: 'CIDR（可选）',
        prefixLength: '前缀长度',
        initialAddresses: '初始地址列表',
        addressesPlaceholder: '每行一个 IPv4 地址',
        loadFailed: '加载独立 IPv4 地址池失败：{error}',
        nameGatewayRequired: '请填写地址池名称和网关',
        createSuccess: '独立 IPv4 地址池已创建',
        createFailed: '创建地址池失败：{error}',
        addressRequired: '请输入要添加的 IPv4 地址',
        addSuccess: '已添加 {count} 个地址',
        addFailed: '添加地址失败：{error}',
        statusUpdateFailed: '更新地址状态失败：{error}',
        deleteConfirm: '删除 IPv4 地址 {address}？',
        deleteFailed: '删除地址失败：{error}',
        status: {free: '可用', assigned: '已分配', disabled: '禁用'},
    },
    invites: {
        title: '邀请码管理',
        description: '生成新的注册链接，并查看每个邀请码的使用情况。',
        backToOverview: '返回概览',
        generateSuccess: '邀请码已生成',
        generateFailed: '生成邀请码失败',
        pointsBalance: '{points} 积分',
        generateTitle: '生成邀请码',
        generateDescription: '选择一种管理员配置的成本方式，生成成功后可复制注册链接给新用户。',
        noCostOptions: '管理员尚未开启用户生成邀请码的价格选项。',
        generating: '生成中',
        generate: '生成邀请码',
        justGenerated: '刚刚生成',
        codeCopied: '邀请码已复制',
        ...
        copyLink: '复制链接',
        myInvites: '我的邀请码',
        myInvitesDescription: '可查看是否已被注册使用，以及注册用户的用户名和邮箱。',
        empty: '暂无邀请码',
        adminGenerated: '管理员生成',
        usedBy: '使用人',
        total: '共 {total} 条',
    ...
    telegramConfig: {
        title: 'Telegram 设置',
        description: '集中管理网站专用机器人、Webhook、入群申请和全局通知渠道。',
        enabled: '启用',
        minutes: '分钟',
        secretInvalid: 'Webhook Secret 只能包含字母、数字、下划线和连字符，长度 1-256。',
        userNumber: '用户 #{id}',
        eligibility: {
            eligible: '已达标',
            ineligible: '未达标',
        ...
        groupRule: {
            chatIdMissing: '未配置 Chat ID',
            recharge: '累计充值 ¥{amount}',
            consume: '累计消费 ¥{amount}',
            noThreshold: '无金额门槛',
            all: '同时满足：{thresholds}',
            any: '满足任一：{thresholds}',
        ...
        footer: {
            title: '站点 Telegram 入口',
            description: '配置侧边栏底部 Telegram 群按钮。留空后隐藏该按钮。',
            link: 'Telegram 群链接',
            hint: '这是网站展示入口，不影响机器人绑定、Webhook 或入群申请逻辑。'
        },
        bot: {
            title: 'Telegram 专用机器人',
            description: '配置网站配套 Bot，用于用户 Telegram 账号绑定和后续私有群准入。',
            enableBinding: '启用绑定机器人',
            disabledHint: '关闭后用户个人设置页会显示未启用，不允许生成绑定链接。',
            username: 'Bot 用户名',
            usernameHint: "不需要填写 {'@'}，用于生成 https://t.me/... 绑定链接。",
            tokenHint: '由 BotFather 分配，保存后只会显示为占位符。',
            generateSecret: '自动生成 Secret',
            secretHint: '必填。自动生成会覆盖当前输入，保存配置后生效；也可用 openssl rand -hex 32 手动生成。',
        },
        webhook: {
            address: 'Webhook 地址：',
            addressHint: '按当前访问域名动态生成；点击“设置 Webhook”时会使用该地址。',
            title: 'Webhook 管理',
            description: '保存 Bot Token 和 Webhook Secret 后，可由系统自动设置回调并同步机器人指令菜单。',
            setting: '设置中',
            setup: '设置 Webhook',
            checking: '检查中',
            check: '检查 Webhook',
            delete: '删除 Webhook',
            currentAddress: '当前地址：',
            pendingUpdates: '待处理更新：{count}',
            maxConnections: '最大连接数：{count}',
            allowedUpdates: '允许更新：{updates}',
            lastError: '最近错误：{error}',
        },
        group: {
            title: '普通用户群入群申请',
            description: '用户绑定 Telegram 后，私聊机器人发送 /join。达标时机器人返回普通群一次性邀请链接。',
            chatId: '普通群 Chat ID',
            chatIdHint: 'Bot 必须是该私有群管理员，并拥有创建邀请链接权限。',
            thresholdMode: '门槛模式',
            modeAny: '累计充值或累计消费，任一达标',
            modeAll: '累计充值和累计消费，同时达标',
            thresholdHint: '门槛为 0 表示该项不参与判断。',
            rechargeThreshold: '累计充值门槛',
            consumeThreshold: '累计消费门槛',
            inviteExpiry: '邀请链接有效期',
            inviteHint: '每次申请生成一个 member_limit=1 的一次性邀请链接。',
        },
        vipGroup: {
            title: '高级用户群入群申请',
            description: '用户绑定 Telegram 后，私聊机器人发送 /join_vip。达标时机器人返回高级群一次性邀请链接。',
            chatId: '高级群 Chat ID',
            chatIdHint: '可以和普通群不同；Bot 必须是该群管理员，并拥有创建邀请链接权限。',
            thresholdHint: '高级群默认建议使用更高门槛，门槛为 0 表示该项不参与判断。',
            inviteHint: '每次申请生成一个 member_limit=1 的高级群一次性邀请链接。',
        },
        bindings: {
            title: '绑定用户与入群资格',
            description: '查看已绑定 Telegram 的站内用户、累计充值/消费和当前入群资格，可人工解除异常绑定。',
            refreshing: '刷新中...',
            refresh: '刷新列表',
            searchPlaceholder: '搜索站内用户名、邮箱、用户 ID、Telegram ID 或用户名',
            clear: '清空',
            groupThreshold: '普通群门槛',
            vipGroupThreshold: '高级群门槛',
            empty: '暂无 Telegram 绑定用户。',
            active: '正常',
            banned: '已封禁',
            userId: '用户 ID {id}',
            recharge: '充值 ¥{amount}',
            ...
            unlinking: '解绑中...',
            unlink: '解除绑定',
            pagination: '共 {total} 条，当前第 {page} / {totalPages} 页',
        },
        channels: {
            title: '全局 Telegram 通知渠道',
            add: '+ 添加渠道',
            description: '创建全局 Telegram 通知渠道后，托管用户可在套餐设置中绑定，当有用户新购或销毁实例时自动发送通知。',
            empty: '暂无全局通知渠道，点击右上角「添加渠道」创建。',
            enabled: '已启用',
            disabled: '已停用',
            boundPackages: '绑定 {count} 个套餐',
            test: '测试',
            edit: '编辑渠道',
            new: '新建渠道',
            name: '渠道名称',
            namePlaceholder: '例：新购通知频道',
            chatIdPlaceholder: '例：-1001234567890',
            chatIdHint: '负数为群组/频道，正数为用户。',
            keepUnchanged: '（留空保持不变）',
            tokenPlaceholder: '例：123456:ABC-DEF...',
            enable: '启用此渠道',
            needToken: '需要 Telegram Bot Token？去',
            botFatherHint: '创建机器人，并将机器人添加为群组/频道管理员。',
        },
        messages: {
            configLoadFailed: '加载 Telegram 配置失败：{error}',
            saveSuccess: '保存成功',
            saveFailed: '保存失败：{error}',
            saveFailedShort: '保存失败',
            groupModeInvalid: '普通群入群门槛模式无效',
            vipGroupModeInvalid: '高级群入群门槛模式无效',
            groupExpiryInvalid: '普通群邀请链接有效期必须在 1 到 10080 分钟之间',
            vipGroupExpiryInvalid: '高级群邀请链接有效期必须在 1 到 10080 分钟之间',
            randomUnsupported: '当前浏览器不支持安全随机数生成，请使用 openssl rand -hex 32 手动生成。',
            secretGenerated: 'Webhook Secret 已生成，请保存 Telegram 配置。',
            webhookCommandsSet: 'Telegram Webhook 和机器人指令已设置',
            webhookSet: 'Telegram Webhook 已设置',
            webhookSetFailed: '设置 Telegram Webhook 失败：{error}',
            webhookUpdated: 'Telegram Webhook 状态已更新',
            webhookCheckFailed: '检查 Telegram Webhook 失败：{error}',
            webhookDeleteConfirm: '确定删除 Telegram Webhook？删除后机器人将不再把消息回调到本站。',
            webhookDeleted: 'Telegram Webhook 已删除',
            webhookDeleteFailed: '删除 Telegram Webhook 失败：{error}',
            bindingsLoadFailed: '加载 Telegram 绑定用户失败：{error}',
            unlinkConfirm: '确定解除 {user} 的 Telegram 绑定？解除后该用户需要重新绑定后才能申请入群。',
            unlinked: 'Telegram 绑定已解除',
            unlinkFailed: '解除绑定失败：{error}',
            channelLoadFailed: '加载渠道失败',
            channelFieldsRequired: '请填写渠道名称和 Chat ID',
            botTokenRequired: '请填写 Bot Token',
            channelUpdated: '渠道已更新',
            channelCreated: '渠道已创建',
            channelDeleteConfirm: '确定删除该渠道？将同时解绑所有绑定此渠道的套餐。',
            channelDeleteFailed: '删除失败：{error}',
    ...
    nav: {
        ...
        userCenter: '用户中心',
        instanceManage: '实例管理',
        instanceTerminal: '实例终端',
        transferInstance: '转移实例',
        domainMail: '域名邮箱',
        myWallet: '我的钱包',
        myOrders: '我的订单',
        giftCardsTicket: '礼品卡券',
        inviteFriends: '邀请好友',
        myFriends: '我的好友',
        ticketSupport: '工单支持',
        helpCenter: '帮助中心',
    ...
    promosAdmin: {
        title: '优惠码管理',
        subtitle: '创建与管理营销折扣券，支持全场通用与树形套餐/方案范围匹配、长周期切片核销与反套利风控。',
        createButton: '创建优惠码',
        refreshButton: '刷新',
        stats: {
            totalCodes: '优惠码总数',
            activeCodes: '生效中券码',
            activeBindings: '活跃绑定实例',
            totalDiscounted: '累计减免金额',
        },
        filters: {
            searchPlaceholder: '搜索优惠码或备注...',
            typeAll: '所有类型',
            typeAdmin: '官方营销券',
            typeAff: '用户推广码',
            statusAll: '所有状态',
        ...
        discountType: {
            percentage: '百分比折扣',
            fixedAmount: '固定金额立减',
            percentageDesc: '{rate}% 折扣',
            fixedAmountDesc: '立减 ¥{amount}',
        },
        durationType: {
            once: '首期一次性',
            repeating: '循环 {cycles} 期',
            forever: '终身有效',
        },
        scopeType: {
            global: '全场通用',
            custom: '指定 {count} 个套餐/方案',
        ...
        drawer: {
            ...
            editTitle: '编辑优惠码',
            codeLabel: '优惠券码',
            codePlaceholder: '如 SUMMER2026（3-32位大写字母/数字）',
            generateRandom: '随机生成',
            nameLabel: '名称 / 备注',
            namePlaceholder: '如 2026年夏季大促活动券',
            discountTypeLabel: '折扣类型',
            discountValueLabel: '折扣数值',
            discountPercentageLabel: '折扣百分比 (%)',
            discountPercentagePlaceholder: '请输入 0-100 的数值（如 20 代表 20% 减免）',
            discountPercentageHint: '请输入 0 到 100 的百分数（如 20 代表减免 20% / 8折）',
            discountFixedLabel: '立减金额 (元)',
            discountFixedPlaceholder: '请输入立减金额（如 15.00）',
            discountPreviewPercentage: '例如：¥100 订单将减免 ¥{discount}，实付 ¥{final}',
            discountPreviewFixed: '例如：¥100 订单将立减 ¥{discount}，实付 ¥{final}',
            discountValuePercentagePlaceholder: '输入折扣比例（如 20 代表减免 20%）',
            discountValueFixedPlaceholder: '输入减免金额（元）',
            fixedAmountNotice: '提示：金额立减优惠码将自动锁定为【首期一次性 (ONCE)】，不参与后续续费循环。',
            durationModeLabel: '有效周期模式',
            durationOnce: '仅首期一次性 (1 期)',
            durationRepeating: '连续多期 (自定义期数)',
            durationForever: '终身永久有效',
            durationTypeLabel: '有效周期',
            durationCyclesLabel: '有效周期数 (期/月)',
            durationCyclesPlaceholder: '请输入有效周期数（如 3、6、12）',
            durationCyclesHint: '输入数字期数（例如填 6 表示连续 6 个月享受折扣），期满后自动恢复原价续费。',
            scopeTypeLabel: '适用范围',
            scopeGlobal: '全场通用（适用于所有套餐方案）',
            scopeCustom: '指定套餐或方案（树形多选）',
            scopeSelectionHint: '勾选套餐时，名下所有子方案均自动生效；也可以展开套餐仅勾选特定子方案。',
            expandAll: '全部展开',
            collapseAll: '全部收起',
            expandPlans: '展开方案 ({count})',
            collapsePlans: '收起方案',
            packageScopeWhole: '整套餐所有方案适用',
            planCoveredByPackage: '已由整套餐覆盖',
            noPlansForPackage: '该套餐暂无可用方案',
            loadingPlans: '正在加载方案...',
            scopeSelectedSummary: '已选 {packages} 个整套餐，{plans} 个指定方案',
            loadingPackages: '正在加载可用套餐与方案列表...',
            noPackages: '未查询到可用套餐',
            maxTotalUsesLabel: '全局总发行量',
            maxTotalUsesPlaceholder: '留空表示不限量',
            maxUsesPerUserLabel: '单用户限用次数',
            maxUsesPerUserPlaceholder: '默认为 1 次',
            startsAtLabel: '生效开始时间',
            expiresAtLabel: '失效截止时间',
            enabledLabel: '立即启用该优惠码',
            immutableNotice: '不可修改',
            editImmutableNotice: '说明：优惠券码、折扣类型、折扣数值、有效周期模式及适用范围一经创建不可修改，仅支持调整名称备注、发行总量、单用户限额、有效时间及启用状态。',
            cancelButton: '取消',
            submitButton: '确认创建',
            submitting: '创建中...',
            saveButton: '保存修改',
        ...
        instancesDrawer: {
            ...
            unbindButton: '解绑',
            unbinding: '解绑中...',
            unbindConfirmTitle: '确认解绑实例？',
            unbindConfirmMessage: '解绑后该实例下次续费将恢复标准原价，并会向用户发送【优惠变更】站内信。',
            emptyText: '当前无实例绑定此优惠码',
        },
        toast: {
            loadSuccess: '优惠码列表已刷新',
            loadFailed: '获取优惠码列表失败：{message}',
            createSuccess: '优惠码创建成功',
            createFailed: '创建优惠码失败：{message}',
            editSuccess: '优惠码修改成功',
            editFailed: '修改优惠码失败：{message}',
            toggleSuccess: '优惠码状态已更新',
            toggleFailed: '更新状态失败：{message}',
            deleteSuccess: '优惠码已成功下线并删除',
            deleteFailed: '删除优惠码失败：{message}',
            unbindSuccess: '实例已成功解除绑定并发送通知',
            unbindFailed: '解除绑定失败：{message}',
            deleteConfirmTitle: '确认下线并删除此优惠码？',
            deleteConfirmMessage: '删除后，名下所有已绑定的实例将解除绑定并恢复官方原价，系统将批量向所有受影响用户发送站内信通知。此操作不可逆！',
            invalidCode: '请输入 3-32 位合法大写优惠券码',
            invalidDiscount: '请输入合法的折扣数值',
            invalidPercentage: '折扣百分比必须在 0 到 100 之间',
            invalidFixedAmount: '立减金额必须大于 0',
            invalidCycles: '有效周期数必须为大于等于 1 的整数',
            scopeRequired: '非全场通用优惠码必须至少选择一个套餐或方案',
        },
    },
    ...
    instance: {
        ...
        createPage: {
            ...
            turnstileFailed: '人机验证失败，请重试',
            selectPackage: '请选择套餐',
            packageSoldOut: '当前套餐已售罄',
            cannotBuyOwn: '不能购买自己发布的付费套餐',
            selectPlanRequired: '请选择购买方案',
            planSoldOut: '所选方案已售罄',
            selectHostRequired: '请选择宿主机',
            selectImageRequired: '请选择系统镜像',
            selectSshKey: '请选择 SSH 密钥',
            authMethod: '认证方式',
            authMethodSsh: 'SSH 密钥',
            authMethodPassword: '密码认证',
            passwordModeAuto: '系统随机生成',
            passwordModeAutoDesc: '开通时自动生成 16 位强密码',
            passwordModeCustom: '自定义密码',
            passwordModeCustomDesc: '手动设置实例 root 密码',
            autoPasswordHint: '系统将在创建时自动生成 16 位高强度密码，创建完成后可在实例详情或连接信息中随时查看与复制。',
            passwordLabel: 'Root 密码',
            passwordPlaceholder: '请输入 root 密码（8-64位，含大小写字母与数字）',
            generatePassword: '随机生成',
            passwordTooWeak: '密码强度不足：需 8-64 位，且包含大写字母、小写字母和数字',
            passwordRequired: '请输入 root 密码',
            switchToPassword: '切换为密码连接',
            noSshKeyConfigured: '未检测到 SSH 密钥',
            noSshKeyHint: '当前账号未添加 SSH 密钥，可直接使用密码连接，或前往个人设置添加公钥。',
            creating: '创建中...',
        ...
        subscription: {
            ...
            applyAffCodeLabel: '优惠码',
            applyAffCodePlaceholder: '输入优惠码',
    ...
    admin: {
        dashboard: {
            ...
            allClearTitle: '系统运行平稳',
            allClearDescription: '所有基础设施节点、支付渠道及交付队列运行正常，未发现阻断风险。',
            actionRequired: '需干预处理',
            actionCount: '{count} 项待办',
            viewDetails: '立即查看',
            deliveryRisk: '{count} 个交付任务异常',
            orderRisk: '{count} 笔订单待核验',
            hostRisk: '{count} 个节点离线或失联',
            ticketRisk: '{count} 张工单待回复',
            otaRisk: '{count} 个更新任务失败',
            revenueTrend: '营收与消费趋势',
            fulfillmentTitle: '今日订单履约',
            fulfillmentSuccess: '已成功',
            fulfillmentPending: '待处理',
            fulfillmentFailed: '失败/已取消',
            fulfillmentRate: '履约成功率 {rate}%',
            instanceStructureTitle: '实例构成与分布',
            expiringNotice: '7 日内即将到期',
            expiringCount: '{count} 台',
            runningHealthyRate: '正常运行率',
            userConversionRate: '付费转化率',
            platformPulseTitle: '平台运行事实',
            activeGateways: '活跃支付渠道',
            smtpStatus: 'SMTP 邮件服务',
            smtpEnabled: '已启用',
            smtpDisabled: '未启用',
            hostsOverview: '宿主机节点',
            agentFreshnessNote: 'Agent 状态按最近 30 分钟心跳计算',
            marketingTitle: '进行中的活动',
            marketingDescription: '抽奖活动、签到福利及参与热度',
            activeCampaignsBadge: '{count} 个进行中',
            dailyCheckin: '每日签到',
            checkinEnabled: '已开启',
            checkinDisabled: '未开启',
            checkinRule: '随机 {min}~{max} 积分',
            todayCheckinsCount: '今日已签到 {count} 人',
            costPointsPerDraw: '{points} 积分/次',
            drawsCount: '已抽 {count} 次',
            longTermActive: '长期有效',
            noActiveLotteries: '当前暂无进行中的抽奖活动',
            manageMarketing: '管理活动 ➔',
            recentInstancesTitle: '最近开机记录',
            recentInstancesDescription: '系统最新创建与交付的实例情况',
            newInstancesTodayBadge: '今日新开 +{count} 台',
            noRecentInstances: '暂无最近开机记录',
            viewAllInstances: '全部实例 ➔',
            pendingTicketsTitle: '待处理工单',
            pendingTicketsDescription: '需管理员跟进与回复的用户工单',
            pendingTicketsBadge: '{count} 条待处理',
            noPendingTickets: '暂无待处理工单，所有工单已完结',
            manageTickets: '进入工单中心 ➔',
        ...
        hosts: {
            ...
            tunnelNotice: '已启用 Agent 反向穿透模式。宿主机无需公网 IP，无需防火墙放行入站端口。',
            targetPort: '通信端口',
            targetPortHint: 'Incus 内部监听通信端口，默认 8443',
            targetHost: '本地转发地址',
            targetHostHint: '宿主机本地回环转发目标，默认 127.0.0.1',
            ...
            tabCreate: '创建',
            basicInfo: '基本信息',
            basicInfoHint: '节点名称、地区与 IPv6 子网信息。',
            connectionConfig: '网络连接',
            connectionConfigHint: '配置后端与宿主机之间的连接方式。',
            resourceTitle: '资源与配额',
            resourceTitleHint: '单个实例可用的 CPU、内存上限与实例类型。',
            natConfigHint: '用户访问端口映射时看到的公网地址与监听地址。',
            deliveryTitle: '交付与展示',
            deliveryTitleHint: '通知、资源池、公告与探针等面向用户的展示设置。',
            config: '配置',
            resourceLimits: '资源限制',
        ...
        images: {
            ...
            batchEnable: '批量启用',
            batchDelete: '批量删除',
            confirmBatchDisable: '确定禁用选中的 {count} 个镜像？',
            confirmBatchEnable: '确定启用选中的 {count} 个镜像？',
            confirmBatchDelete: '确定删除选中的 {count} 个镜像？此操作不可恢复。',
            batchDisableSuccess: '已禁用 {count} 个镜像',
            batchEnableSuccess: '已启用 {count} 个镜像',
            batchDeleteSuccess: '已删除 {count} 个镜像',
            selectedCount: '已选择 {count} 项',
            clearSelection: '取消选择',
            validation: {
    ...
    traffic: {
        ...
        peak: '峰值',
        dailyAverage: '日均',
        nextFreeReset: '下次免费重置',
        paidResetHint: '下次免费重置 {date} · 用尽后可按 CN¥{price} 付费重置',
    ...
    host: {
        ...
        caddy: {
            ...
            enabled: '已启用',
            disabled: '未启用',
            notInstalled: 'Caddy 尚未安装，点击下方按钮由 Agent 在宿主机上自动安装。',
            install: '安装 Caddy',
    ...
    terminal: {
        errors: {
            authenticationRequired: '需要登录后才能连接',
            connectionLost: '连接已中断',
            terminalLine: '错误：{error}',
            invalidId: '实例 ID 无效',
            originNotAllowed: '当前来源不允许连接终端',
            ipLimitExceeded: '当前 IP 的终端连接过多',
            sessionInvalidated: '登录会话已失效',
            userLimitExceeded: '当前账号的终端连接过多',
            connectionLimitExceeded: '终端连接数已达上限',
            instanceNotFound: '实例不存在',
            forbidden: '无权连接此实例',
            instanceNotRunning: '实例未运行',
            instanceLimitExceeded: '该实例的终端连接过多',
            hostNotFound: '实例节点不存在',
